...
log_file = joinpath(log_dir, "quench_from_CDW_to_CDW.log")
...
pre_quench = SSHParams(v = 1.0, w= 1.0, Δ = 0, V = 5.0)
...
filename = "run_LL_quench_from_CDW_to_CDW_200sites_10sec_bonddim$(bond_dimension)_cutoff$(cutoff).csv"
