...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_decrease_V_DV05_$(T_max)_centered_subsystem_l100.log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_decrease_V_DV05_$(T_max)_centered_subsystem_l100.h5")
...
times, entropies, variances = simulate_quench(
    ...
    checkpoint_file=checkpoint_file, checkpoint_every=20, subsystem_a = 51, subsystem_b = 150, entropy_every=20
)
...
filename = "run_LL_quench_from_LL_to_LL_decrease_V_DV05_200sites_time$(T_max)_bonddim$(bond_dimension)_cutoff$(cutoff)_centered_subsystem_l100.csv"
