...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_decrease_V_DV02_$(T_max)_centered_subsystem_l40.log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_decrease_V_DV02_$(T_max)_centered_subsystem_l40.h5")
...
filename = "run_LL_quench_from_LL_to_LL_decrease_V_DV02_200sites_time$(T_max)_bonddim$(bond_dimension)_cutoff$(cutoff)_centered_subsystem_l40.csv"
