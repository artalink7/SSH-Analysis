...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_decrease_V_DV02_$(T_max)_centered_subsystem_l46.log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_decrease_V_DV02_$(T_max)_centered_subsystem_l46.h5")
...
times, variances = simulate_quench_only_fluctuations(
    ...
    checkpoint_file=checkpoint_file, checkpoint_every=20, subsystem_a = 77, subsystem_b = 122
)
...
filename = "run_LL_quench_from_LL_to_LL_decrease_V_DV02_200sites_time$(T_max)_bonddim$(bond_dimension)_cutoff$(cutoff)_centered_subsystem_l46.csv"
