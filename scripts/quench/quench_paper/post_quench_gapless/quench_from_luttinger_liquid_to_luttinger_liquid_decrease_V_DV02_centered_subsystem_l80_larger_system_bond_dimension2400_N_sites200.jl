...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_bd2400_$(N_sites)decrease_V_DV02_$(T_max)_centered_subsystem_l80.log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_bd2400_$(N_sites)_decrease_V_DV02_$(T_max)_centered_subsystem_l80.h5")
...
filename = "run_LL_quench_from_LL_to_LL_decrease_V_DV02_sites$(N_sites)_time$(T_max)_bonddim$(bond_dimension)_cutoff$(cutoff)_centered_subsystem_l80.csv"
