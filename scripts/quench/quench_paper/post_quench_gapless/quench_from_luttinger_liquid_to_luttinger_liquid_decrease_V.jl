...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_decrease_V.log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_decrease_V.h5")
...
filename = "run_LL_quench_from_LL_to_LL_decrease_V_200sites_10sec_bonddim$(bond_dimension)_cutoff$(cutoff).csv"
