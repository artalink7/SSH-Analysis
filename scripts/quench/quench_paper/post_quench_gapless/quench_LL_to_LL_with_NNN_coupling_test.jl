...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_NNN_coupling_bd1600_$(N_sites)_decrease_V_DV02_$(T_max)_centered_subsystem_l80_testing_$(dt).log")
checkpoint_file = joinpath(ckpt_dir, "quench_from_LL_to_LL_NNN_coupling_bd1600_$(N_sites)_decrease_V_DV02_$(T_max)_centered_subsystem_l80_testing_$(dt).h5")
...
pre_quench =  ExtendedTBParams(t0=1.0, t2=0.0, V=0.7)
post_quench = ExtendedTBParams(t0=1.0, t2=0.0, V=0.5)
...
filename = "quench_from_LL_to_LL_NNN_coupling_decrease_V_DV02_sites$(N_sites)_time$(T_max)_bonddim$(bond_dimension)_cutoff$(cutoff)_central_subsystem_l80_testing_dt$(dt).csv"
