...
mkpath(log_dir)
mkpath(ckpt_dir)
log_file = joinpath(log_dir, "quench_from_LL_to_LL_decrease_V_DV02_$(T_max)_centered_subsystem.log")
...
times, entropies, variances = simulate_quench(
    ...
    checkpoint_file=checkpoint_file, checkpoint_every=20, subsystem_a = N_sites ÷ 4 + 1, subsystem_b = 3 * N_sites ÷ 4
)
