...
N_cells = 200:40:800
Variance = vec(readdlm("data/equilibrium/entropy_vs_Ncells_almostgapless_half_filling.txt")) 
...
savefig("plot/variance_vs_logNcells_almostgapless_half_filling_fit.pdf")
